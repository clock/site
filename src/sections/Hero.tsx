          ...
          >
            ...
            >
              <motion.button
                ...
                className="px-8 py-4 bg-accent text-white font-medium hover:bg-accent-dark transition-colors border border-accent"
              >
                View Projects
              </motion.button>
              <motion.button
                ...
                className="px-8 py-4 border border-border-dark text-gray-300 hover:border-accent hover:text-white transition-colors font-medium"
              >
                Get In Touch
              </motion.button>
            </motion.div>
